...
chatbot-ui/
  ...
  docs/
    ...
    WORKFLOW_DONE_SO_FAR.md
    FRONTEND_HOSTING_VERCEL.md
    TEACHER_QA_PREP.md
    MISCELLANEOUS_DUMPS.md
...
Old root-level frontend files were not deleted. They are kept as backup/reference.
...
$LogFolder = Join-Path $ProjectRoot "storage\logs"
...
- `$PythonExe` points to the virtual environment Python.
